...
var Docker =(function () {
  ...
  // contructor for Docker class
  function Docker(config){ 
    this.docker = new Dockerode();
  }

  Docker.prototype.start = async function (request, reply) {
  ...
  Docker.prototype.stop = async function (request, reply) {
  ...
  Docker.prototype.buildImage = function (context, src, imageTag) {
